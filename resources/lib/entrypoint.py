...
def resetAuth():
    ...
    if resp:
        ...
        xbmc.executebuiltin('Addon.OpenSettings(emby.for.kodi)')

def addDirectoryItem(label, path, folder=True):
    li = xbmcgui.ListItem(label, path=path)
    li.setThumbnailImage("special://home/addons/emby.for.kodi/icon.png")
    li.setArt({"fanart":"special://home/addons/emby.for.kodi/fanart.jpg"})
    li.setArt({"landscape":"special://home/addons/emby.for.kodi/fanart.jpg"})
