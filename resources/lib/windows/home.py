...
class HomeWindow(kodigui.BaseWindow, util.CronReceiver):
    ...
    def displayServerAndUser(self, **kwargs):
        ...
        if plexapp.SERVERMANAGER.selectedServer:
            ...
            self.setProperty('server.icon', 'script.emby/home/device/plex.png')  # TODO: Set dynamically to whatever it should be if that's how it even works :)
            self.setProperty('server.iconmod', plexapp.SERVERMANAGER.selectedServer.isSecure and 'script.emby/home/device/lock.png' or '')
        else:
            self.setProperty('server.name', T(32338, 'No Servers Found'))
            self.setProperty('server.icon', 'script.emby/home/device/error.png')
    ...
    def showSections(self):
        ...
        if pl:
            plli = kodigui.ManagedListItem('Playlists', thumbnailImage='script.emby/home/type/playlists.png', data_source=PlaylistsSection)
        ...
        for section in sections:
            mli = kodigui.ManagedListItem(section.title, thumbnailImage='script.emby/home/type/{0}.png'.format(section.type), data_source=section)
    ...
    def createEpisodeListItem(self, obj, wide=False):
        ...
        mli.setProperty('thumb.fallback', 'script.emby/thumb_fallbacks/show.png')
    ...
    def createMovieListItem(self, obj, wide=False):
        ...
        mli.setProperty('thumb.fallback', 'script.emby/thumb_fallbacks/movie.png')
        if not obj.isWatched:
            mli.setProperty('unwatched', '1')
        return mli
    ...
    def createAlbumListItem(self, obj, wide=False):
        ...
        mli.setProperty('thumb.fallback', 'script.emby/thumb_fallbacks/music.png')
        return mli
    ...
    def createPhotoListItem(self, obj, wide=False):
        ...
        mli.setProperty('thumb.fallback', 'script.emby/thumb_fallbacks/photo.png')
        return mli
    ...
    def createClipListItem(self, obj, wide=False):
        ...
        mli.setProperty('thumb.fallback', 'script.emby/thumb_fallbacks/movie16x9.png')
        return mli
    ...
    def createPlaylistListItem(self, obj, wide=False):
        ...
        mli.setProperty('thumb.fallback', 'script.emby/thumb_fallbacks/{0}.png'.format(obj.playlistType == 'audio' and 'music' or 'movie'))
        return mli
