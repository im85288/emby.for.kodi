...
class PinLoginWindow(kodigui.BaseWindow):
    ...
    def setPin(self, pin):
        self.setProperty('pin.image.0', 'script.emby/sign_in/digits/{0}.png'.format(pin[0].upper()))
        self.setProperty('pin.image.1', 'script.emby/sign_in/digits/{0}.png'.format(pin[1].upper()))
        self.setProperty('pin.image.2', 'script.emby/sign_in/digits/{0}.png'.format(pin[2].upper()))
        self.setProperty('pin.image.3', 'script.emby/sign_in/digits/{0}.png'.format(pin[3].upper()))
